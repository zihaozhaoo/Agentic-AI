...
type LayoutRouteId = RouteId | "/" | "/(game)/agents" | "/(game)/agents/[agent_id]" | "/(game)/agents/directory" | "/(game)/agents/my-agents" | "/(game)/agents/register" | "/(game)/battles" | "/(game)/battles/[battle_id]" | "/(game)/battles/ongoing" | "/(game)/battles/past" | "/(game)/battles/stage-battle" | "/(game)/dashboard" | "/auth/callback" | "/docs" | "/docs/api/api-reference" | "/docs/cli/cli-reference" | "/docs/getting-started/making-new-docs" | "/docs/getting-started/quick-start" | "/login" | null
