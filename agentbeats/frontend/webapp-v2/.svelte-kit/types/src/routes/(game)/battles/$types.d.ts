...
type LayoutRouteId = RouteId | "/(game)/battles" | "/(game)/battles/[battle_id]" | "/(game)/battles/ongoing" | "/(game)/battles/past" | "/(game)/battles/stage-battle"
type LayoutParams = RouteParams & { battle_id?: string }
