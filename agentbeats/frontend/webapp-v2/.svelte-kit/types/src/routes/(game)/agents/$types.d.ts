...
type LayoutRouteId = RouteId | "/(game)/agents" | "/(game)/agents/[agent_id]" | "/(game)/agents/directory" | "/(game)/agents/my-agents" | "/(game)/agents/register"
type LayoutParams = RouteParams & { agent_id?: string }
