...
def main():
    ...
    # Spread vehicles evenly across taxi zones to avoid the clustered starting layout
    ...
    # Compress request arrival times to keep vehicles busy throughout the run
    requests = environment.generate_requests_from_data(
        parquet_path=parquet_file,
        n_requests=2000, # larger batch for comprehensive evaluation
        augment_location=False,
        mean_interarrival_seconds=12.0,
